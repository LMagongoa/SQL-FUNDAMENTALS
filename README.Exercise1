Exercise 1 - Learning the basics of SQL coding 

Exercise 1: SQL Fundamentals
Database: employees_db
Assume you have a table called employees with the following structure:

![image](https://github.com/user-attachments/assets/35f82a22-1561-4819-8df3-c119dd56bacd)
...
5. WHERE Statement
6. Write a SQL query to find employees who work in the IT department.
6. AND Statement
